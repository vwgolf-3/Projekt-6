...
// PINs SPI
#define SPI_CS_RC522_BIT (1<<0)						// Bit-Zuweisung PB5 (Arduino: 49, Pinnr: 23)
#define SPI_MISO_BIT (1<<3)							// Bit-Zuweisung PB3 (Arduino: 50, Pinnr: 22)
#define SPI_MOSI_BIT (1<<2)							// Bit-Zuweisung PB2 (Arduino: 51, Pinnr: 21)
#define SPI_CLK_BIT (1<<1)							// Bit-Zuweisung PB1 (Arduino: 52, Pinnr: 20)
#define SPI_CS_TMC4671_BIT (1<<5)					// Bit-Zuweisung PB0 (Arduino: 53, Pinnr: 19)
...
// Output Maske PORTB
#define SPI_OUTPUT_MASK (SPI_MOSI_BIT|SPI_CLK_BIT|SPI_CS_TMC4671_BIT|EN_TMC4671|HEARTBEAT_LED)

// Output Maske PORTF
#define LED_OUTPUT_MASK (REF0_BIT|REF1_BIT|REF2_BIT|LEDR_BIT|LEDG_BIT|LEDB_BIT|LEDW_BIT)

// Output Maske PORTC
#define RFID_MASK (SPI_CS_RC522_BIT)

// MAKROS
#define TOGGLE_LED() SPI_PORT = SPI_PORT ^ HEARTBEAT_LED

// Output Maske PORT
#define PUMPE_OUTPUT_MASK_G (PUMPE6_BIT)
#define PUMPE_OUTPUT_MASK_J (PUMPE7_BIT|PUMPE8_BIT|PUMPE9_BIT|PUMPE10_BIT|PUMPE11_BIT)
...
#define ENABLE_TMC4671() SPI_PORT &= ~SPI_CS_TMC4671_BIT
#define DISABLE_TMC4671() SPI_PORT |= SPI_CS_TMC4671_BIT

#define ENABLE_RC522() RFID_PORT &= ~SPI_CS_RC522_BIT
#define DISABLE_RC522() RFID_PORT |= SPI_CS_RC522_BIT
