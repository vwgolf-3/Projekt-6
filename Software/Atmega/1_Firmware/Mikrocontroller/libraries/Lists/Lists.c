...
file_list_node_t* create_list_node(file_node_t * node, int * number)
{
	...
	new_list_node->getraenk_file = node;
...
//     else
//     {
//         for (ptr_list_node = *first, i = 0; i < *number; ptr_list_node = ptr_list_node->next,i++)
//         {
//             if (ptr_list_node->file == oldval)
//             {
//                 ptr_list_node->file = newval;
//                 Uart_Transmit_IT_PC("Element upgedated.\r");
//                 f = 1;
//             }
//         }
