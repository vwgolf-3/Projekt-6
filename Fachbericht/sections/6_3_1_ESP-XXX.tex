...
Die Inbetriebnahme des ESP32-WROOM-32U geschieht mit der Programmierumgebung Arduino IDE. Um diesen in Betrieb nehmen zu können, waren einige Einstellungen und Downloads nötig, welche dann in der Arduino IDE eingebunden werden mussten. Im Folgenden wird beschrieben, wie vorgegangen werden kann damit sich dieses im vorgegebenen Netz anmeldet und als Webhost dient. Es wurde getestet, ob bei Klicken auf ein Button im Explorer ein Event ausgelöst wird und ob die Kommunikation zwischen \textmu C und ESP funktioniert.
