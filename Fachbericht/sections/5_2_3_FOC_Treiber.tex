...
Wie erwähnt wird ein TMC4671 als FOC-Treiber verwendet. Da das Gehäuse des IC's nur schwierig lötbar ist, wird ein Breakout-Board (BOB) eingesetzt.
...
Im Folgenden werden kurz die Teilsysteme auf dem TMC4671-BOB beschrieben, welche für den Partymixer gebraucht werden. Dazu wird auf das Layout vom Trinamic zurückgegriffen. Sämtliche Teilschemas sind im Anhang Kapitel \ref{Appendix:BOB} aufgezeigt. \cite{trinamicmotion_control_gmbh__co_kg_tmc4671-bob_2020}
...
Die Ausgangssignale für den Gate-Treiber gehen direkt auf die Header-Pins des BOBs.
