...
Der FOC-Treiber berechnet den Modulationsindex für die H-Brücke anhand des Drehmoments, der Geschwindigkeit oder der Position, welche der Mikrocontroller dem FOC-Treiber vorgibt. Die vom FOC-Treiber ausgehenden PWM-Leitungen gehen direkt auf den Gate-Treiber, welcher dann wiederum die MOSFETs ansteuert.
Auf den FOC-Treiber und weitere für diesen Schaltkreis benötigte Komponenten wird im folgenden eingegangen.
Da in diesem Projekt die Gewichtung auf dem Aufbau der Cocktailmaschine liegt, wird ein Breakout-Board (BOB) verwendet, welche die Aufgabe der Kommuntierung übernimmt.
...
\paragraph{Schaltungsaufbau}\label{par:Schaltungsaufbau_TMC4671}\mbox{}
...
Der Kommunikationseingang ist nicht speziell geschützt. Hier ist für das eigene Layout darauf zu achten, dass die Eingänge nicht mit mehr als 3.3V belastet werden. Dies wird mit einem Level-Shifter zwischen Mikrocontroller und TMC4672 gewährleistet.
