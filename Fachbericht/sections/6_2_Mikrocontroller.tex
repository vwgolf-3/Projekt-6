...
\subsubsection{AVRdude in Atmel Studio einbinden}
...
Für die Inbetriebnahme des Mikrocontrollers wurde der Alternativweg gewählt. Die Ergebnisse können sich zeigen lassen. Der Mikrocontroller ist programmierbar und erste Tests mit der Software waren erfolgreich, was im nächsten Kapitel gezeigt wird.
...
Auch das Einbinden von AVRdude in Atmel Studio wurde überprüft. Es galt herauszufinden, ob und wie der Handshake durchgeführt wird. Dazu wurde an den folgenden Leitungen gemessen:
...
\begin{figure}[h!]
\center
\includegraphics[width = 0.8 \textwidth]{graphics/ATMega2560_DTR_RESET_RX_TX_gesamt}
...
\begin{figure}[h!]
\center
\includegraphics[width = 0.8 \textwidth]{graphics/ATMega2560_DTR_RESET_RX_TX_1}
\caption{Handshake zum Hochladen des Programmcodes auf den ATMega2560.}
\label{fig:ATMega2560_DTR_RESET_RX_TX_1}
\end{figure}

Das Programm wurde auch ordnungsgemäss gestartet. Dies wurde geprüft, indem der während dem Projekt 5 erarbeitete Code hochgeladen wurde.
