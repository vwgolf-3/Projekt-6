...
Die Messung des Oszillator-Eingangs ergab eine saubere harmonische Schwingung mit 16MHz, abgebildet in Abbildung \ref{fig:Crystal_Swing}. Das Programm wurde auch ordnungsgemäss gestartet. Dies wurde geprüft, indem in der while-Schleife eine heartbeat-LED immer nach einer Sekunde toggelt.

\begin{figure}[h!]
\center
\includegraphics[width = \textwidth]{graphics/Crystal_Swing}
