...
\end{align}
\todo{R39 = +-300 Ohm für ''optimal transient response'' erwähnen}
...
\label{equ:Vovp_12V}
\end{align}
\todo{R39 = +-300 Ohm für ''to reduce power dissipation'' erwähnen}
